...
impl AdminControlPlaneHandle {
    ...
    pub async fn surface_permissions_for_principal(
        ...
        self.permissions_for_principal(principal_id).await
    }
}
