...
use mc_core::{
    BlockPos, ChunkColumn, DroppedItemSnapshot, EntityId, InventoryContainer, InventorySlot,
    InventoryTransactionContext, InventoryWindowContents, ItemStack, PlayerSnapshot,
...
pub const JE_47_ADAPTER_ID: &str = "je-47";
...
#[derive(Default)]
pub struct Je47Profile {
    sessions: JavaProtocolSessionStore,
}

pub type Je47Adapter = JavaEditionAdapter<Je47Profile>;

impl JavaEditionProfile for Je47Profile {
