...
impl AdminPermission {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ReloadTopology => "reload-topology",
...
impl AdminRequest {
    ...
    pub const fn required_permission(&self) -> Option<AdminPermission> {
        match self {
            ...
            Self::ReloadTopology => Some(AdminPermission::ReloadTopology),
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct AdminTopologyGenerationCountView {
...
pub struct AdminSessionSummaryView {
    ...
    pub by_topology_generation: Vec<AdminTopologyGenerationCountView>,
...
pub struct AdminStatusView {
    pub active_topology_generation_id: u64,
    pub draining_topology_generation_ids: Vec<u64>,
...
pub struct AdminSessionView {
    ...
    pub topology_generation_id: u64,
    pub transport: TransportKind,
    pub phase: ConnectionPhase,
...
pub enum AdminResponse {
    ...
    ReloadTopology(AdminTopologyReloadView),
    ShutdownScheduled,
    PermissionDenied {
