...
#[path = "../../../je-404/mc-proto-je-404/src/decoding.rs"]
mod decoding;
#[path = "../../../je-404/mc-proto-je-404/src/encoding.rs"]
mod encoding;
...
use mc_proto_je_common::{
    __version_support::inventory::{
        CURSOR_SLOT_ID, CURSOR_WINDOW_ID, InventoryProtocolSpec, JE_1_13_2_INVENTORY_SPEC,
...
pub const PROTOCOL_VERSION_26_1: i32 = 775;
pub const VERSION_NAME_26_1: &str = "26.1";
pub const JE_775_ADAPTER_ID: &str = "je-775";
pub(crate) const INVENTORY_SPEC: InventoryProtocolSpec = JE_1_13_2_INVENTORY_SPEC;
...
const PACKET_CB_TRANSACTION: i32 = 0x12;
const PACKET_CB_CLOSE_WINDOW: i32 = 0x13;
const PACKET_CB_OPEN_WINDOW: i32 = 0x14;
const PACKET_CB_WINDOW_ITEMS: i32 = 0x15;
const PACKET_CB_WINDOW_PROPERTY: i32 = 0x16;
const PACKET_CB_SET_SLOT: i32 = 0x17;
const PACKET_CB_PLAY_DISCONNECT: i32 = 0x1b;
const PACKET_CB_KEEP_ALIVE: i32 = 0x21;
const PACKET_CB_MAP_CHUNK: i32 = 0x22;
const PACKET_CB_JOIN_GAME: i32 = 0x25;
const PACKET_CB_PLAYER_ABILITIES: i32 = 0x2e;
const PACKET_CB_PLAYER_INFO: i32 = 0x30;
const PACKET_CB_PLAYER_POSITION_AND_LOOK: i32 = 0x32;
const PACKET_CB_DESTROY_ENTITIES: i32 = 0x35;
const PACKET_CB_ENTITY_HEAD_ROTATION: i32 = 0x39;
const PACKET_CB_HELD_ITEM_CHANGE: i32 = 0x3d;
const PACKET_CB_ENTITY_METADATA: i32 = 0x3f;
const PACKET_CB_UPDATE_HEALTH: i32 = 0x44;
const PACKET_CB_SPAWN_POSITION: i32 = 0x49;
const PACKET_CB_TIME_UPDATE: i32 = 0x4a;
const PACKET_CB_ENTITY_TELEPORT: i32 = 0x50;

const PACKET_SB_KEEP_ALIVE: i32 = 0x0e;
const PACKET_SB_FLYING: i32 = 0x0f;
const PACKET_SB_POSITION: i32 = 0x10;
const PACKET_SB_POSITION_LOOK: i32 = 0x11;
const PACKET_SB_LOOK: i32 = 0x12;
const PACKET_SB_PLAYER_DIGGING: i32 = 0x18;
const PACKET_SB_HELD_ITEM_CHANGE: i32 = 0x21;
const PACKET_SB_CREATIVE_INVENTORY_ACTION: i32 = 0x24;
const PACKET_SB_PLAYER_BLOCK_PLACEMENT: i32 = 0x29;
const PACKET_SB_USE_ITEM: i32 = 0x2a;
const PACKET_SB_CLIENT_COMMAND: i32 = 0x03;
const PACKET_SB_SETTINGS: i32 = 0x04;
const PACKET_SB_CONFIRM_TRANSACTION: i32 = 0x06;
const PACKET_SB_CLOSE_WINDOW: i32 = 0x09;
const PACKET_SB_CLICK_WINDOW: i32 = 0x08;

#[derive(Default)]
pub struct Je775Profile {
    sessions: JavaProtocolSessionStore,
}

pub type Je775Adapter = JavaEditionAdapter<Je775Profile>;

impl JavaEditionProfile for Je775Profile {
    ...
    fn descriptor(&self) -> ProtocolDescriptor {
        ProtocolDescriptor {
            adapter_id: JE_775_ADAPTER_ID.to_string(),
            transport: TransportKind::Tcp,
            wire_format: WireFormatKind::MinecraftFramed,
            edition: mc_proto_common::Edition::Je,
            version_name: VERSION_NAME_26_1.to_string(),
            protocol_number: PROTOCOL_VERSION_26_1,
        }
    }
