...
pub const JE_404_ADAPTER_ID: &str = "je-404";
...
#[derive(Default)]
pub struct Je404Profile {
    sessions: JavaProtocolSessionStore,
}

pub type Je404Adapter = JavaEditionAdapter<Je404Profile>;

impl JavaEditionProfile for Je404Profile {
